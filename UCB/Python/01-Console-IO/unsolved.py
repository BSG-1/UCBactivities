...
middleInit = input("What is your middle initial?")
...
print('Hello {0} {1}. {2}'.format(firstName, middleInit, lastName))
print('Here is your profile information:') 
print('{0}'.format(address))
print('{0}'.format(email)) 
print('{0}'.format(phoneNumber))


# print('The student\s last name is:'.format(lastName)
# print('The student\s middle initial is:'.format(middleInit)
# print('The student\s address is:'.format(address)
# print('The student\s email is:'.format(email) 
# print('The student\s phone number is:'.format(phoneNumber)
###############################################################################
